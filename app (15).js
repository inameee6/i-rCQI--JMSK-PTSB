      ...
      <div class="section-block">
        ...
        <div class="mt-2"><b class="text-sm">5.1 Gred Pelajar (% pelajar)</b>
          <div class="alert alert-info mt-1" style="margin-bottom:8px;font-size:12px;">
            💡 <b>Cara isi:</b> Masukkan <b>peratusan (%) pelajar</b> bagi setiap gred. Jumlah semua gred mestilah <b>= 100%</b>.
          </div>
        ...
        <div class="mt-2"><b class="text-sm">5.2 Quality Objectives (Auto-Kira)</b>
          ...
          <div class="section-block mt-1" style="background:var(--primary-light);">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
              <div>
                <div class="text-sm text-muted mb-0" id="qo1-label">≥90% pelajar capai gred D ke atas</div>
                <div id="qo1-result" style="font-size:20px;font-weight:700;margin:4px 0;">—</div>
                <div id="qo1-calc" class="text-sm text-muted"></div>
              </div>
              <div>
                <div class="text-sm text-muted mb-0" id="qo2-label">≥25% pelajar capai gred B ke atas</div>
...
function onKursusChange() {
  ...
  if (badge) { badge.textContent = `KPI Kursus ini: QO1 ≥${t1}% | QO2 ≥${t2}%`; badge.style.display = 'inline-block'; }
  if (lbl1) lbl1.textContent = `≥${t1}% pelajar capai gred D ke atas`;
  if (lbl2) lbl2.textContent = `≥${t2}% pelajar capai gred B ke atas`;
}
...
function autoCalcQO() {
  ...
  const lbl2 = document.getElementById('qo2-label');
  if (badge) {
    badge.textContent = `KPI Kursus ini: QO1 ≥${threshold1}% | QO2 ≥${threshold2}%`;
    badge.style.display = 'inline-block';
  }
  if (lbl1) lbl1.textContent = `≥${threshold1}% pelajar capai gred D ke atas`;
  if (lbl2) lbl2.textContent = `≥${threshold2}% pelajar capai gred B ke atas`;
