...
function renderDashPDFTable(logs) {
  if (!logs.length) return `<p class="text-sm text-muted">No PDFs found for the selected filters.</p>`;
  return `<div class="table-wrap"><table>
    <thead><tr><th>#</th><th>File Name</th><th>Course</th><th>Session</th><th>Generated By</th><th>Date</th><th></th></tr></thead>
...
function renderFullPDFArchivePage() {
  ...
  return `
    ...
    <div class="card">
      <div id="pdf-full-list">${renderDashPDFTable(logs)}</div>
    </div>`;
}
