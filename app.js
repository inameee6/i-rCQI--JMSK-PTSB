  ...
  <div class="modal-bg open" id="modal-report">
    <div class="modal">
      ...
      <div class="section-block">
        ...
        <div class="mt-2">
          <div class="flex items-center justify-between"><b class="text-sm">1.2/1.3 Class &amp; Lecturer</b><button class="btn btn-outline btn-sm" type="button" onclick="addLecturerRow()">+ Tambah</button></div>
        ...
        <div class="mt-2"><b class="text-sm">5.2 Quality Objectives (Auto-Calculated)</b>
          ...
          <div class="section-block mt-1" style="background:var(--primary-light);">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
              <div>
                <div class="text-sm text-muted mb-0" id="qo1-label">≥90% students achieved grade D and above</div>
                <div id="qo1-result" style="font-size:20px;font-weight:700;margin:4px 0;">—</div>
                <div id="qo1-calc" class="text-sm text-muted"></div>
              </div>
              <div>
                <div class="text-sm text-muted mb-0" id="qo2-label">≥25% students achieved grade B and above</div>
...
function onKursusChange() {
  ...
  if (lbl1) lbl1.textContent = `≥${t1}% students achieved grade D and above`;
  if (lbl2) lbl2.textContent = `≥${t2}% students achieved grade B and above`;
}
...
function autoCalcQO() {
  ...
  if (lbl1) lbl1.textContent = `≥${threshold1}% students achieved grade D and above`;
  if (lbl2) lbl2.textContent = `≥${threshold2}% students achieved grade B and above`;
  ...
  <div class="modal-bg open" id="modal-detail">
    <div class="modal" style="max-width:820px;">
      ...
      <div class="section-block">
        <div class="card-title mb-0"><span class="card-num">7</span>Lampiran</div>
        <div class="text-sm">
          ${r.LampiranMinitURL ? `<div class="file-item">Discussion Minutes: <a href="${esc(r.LampiranMinitURL)}" target="_blank" class="file-link">Lihat fail ↗</a></div>` : '<div class="text-muted">Discussion Minutes: tiada</div>'}
