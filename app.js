      ...
      <div class="section-block">
        ...
        <div class="mt-2"><b class="text-sm">5.1 Gred Pelajar (% pelajar)</b>
          <div class="alert alert-info mt-1" style="margin-bottom:8px;font-size:12px;">
            💡 <b>Cara isi:</b> Masukkan <b>peratusan (%) pelajar</b> yang mendapat setiap gred. Contoh: jika 5 daripada 40 pelajar dapat A+, isi <b>12.5</b> (bukan 5). Jumlah keseluruhan semua gred mestilah <b>bersamaan atau hampir 100%</b>.
          </div>
          <div class="table-wrap mt-1">
            <table style="font-size:11px;">
              ...
              <tbody><tr id="grade-row-inputs">${['A+','A','A-','B+','B','B-','C+','C','C-','D+','D','E','E-','F'].map(g => {
                ...
                return `<td><input type="number" step="0.1" min="0" max="100" data-grade="${g}" value="${esc(gd[g] || '')}" style="width:48px;padding:4px;font-size:11px;" oninput="autoCalcQO()"></td>`;
              }).join('')}
          ...
          <div class="form-hint mt-1">Jumlah semua gred patut bersamaan 100% (atau hampir).</div>
        </div>
...
function autoCalcQO() {
  ...
  if (totalEl) {
    ...
    totalEl.style.color = total > 101 ? 'var(--danger)' : total >= 98 ? 'var(--success)' : 'var(--primary)';
  }
  if (warnEl) warnEl.classList.toggle('hidden', total <= 101);
