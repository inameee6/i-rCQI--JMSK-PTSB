  ...
  <div class="modal-bg open" id="modal-detail">
    <div class="modal" style="max-width:820px;">
      ...
      <div class="section-block">
        <div class="card-title mb-0"><span class="card-num">7</span>Lampiran</div>
        <div class="text-sm">
          ${r.LampiranMinitURL ? `<div class="file-item">Discussion Minutes: <a href="${esc(r.LampiranMinitURL)}" target="_blank" class="file-link">View fail ↗</a></div>` : '<div class="text-muted">Discussion Minutes: tiada</div>'}
          ${r.LampiranAktivitiURL ? `<div class="file-item">Laporan Aktiviti: <a href="${esc(r.LampiranAktivitiURL)}" target="_blank" class="file-link">View fail ↗</a></div>` : '<div class="text-muted">Laporan Aktiviti: tiada</div>'}
        </div>
      </div>
      ...
      <div class="section-block">
        ...
        <div class="form-grid mt-2">
          <div>
            <b class="text-sm">Disediakan oleh (Course Coordinator)</b>
          ...
          <div>
            <b class="text-sm">Disahkan oleh (Course Head)</b>
...
function generateReportPDF(id) {
  ...
  doc.setFontSize(9); doc.setFont('helvetica', 'bold');
  doc.text('Disediakan oleh (Course Coordinator)', leftX, sigY);
  doc.text('Disahkan oleh (Course Head)', rightX, sigY);
  y = sigY + 5;
